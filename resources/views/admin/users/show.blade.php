...
{{-- Menu Breadcrumb --}}
@section('breadcrumb')
    <a class="btn" onclick="event.preventDefault();confirmDeletion('{{ route('users.destroy', [$user->id]) }}');" ><i class="icon-trash"></i> Hapus</a>
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <img src="{{ asset(config('central.path.avatars').'/'.$user->avatar) }}" />
                        </div>
                    </div>
                </form>
            </div>
